                    ...
                    <form action="${pageContext.request.contextPath}/prets/emprunter" method="post" autocomplete="off">
                        <div class="form-group">
                            ...
                            <input type="text" name="livreNom" id="livre" required class="form-control"
                                placeholder="Commencez à taper le titre ou l'auteur..." <c:if
                                test="${adherentPenalise}">disabled</c:if>>
                        ...
                        <div class="form-group">
                            ...
                            <select name="typePret" id="typePret" required class="form-control" <c:if
                                test="${adherentPenalise}">disabled</c:if>>
                        ...
                        <div class="btn-group">
                            <input type="submit" value="Emprunter" class="btn btn-primary" <c:if
                                test="${adherentPenalise}">disabled title="Emprunt impossible : vous êtes actuellement
                            pénalisé"</c:if>/>
                            <button type="button" class="btn btn-secondary"
                                onclick="window.location.href='${pageContext.request.contextPath}/frontoffice'">
                                Retour à l'accueil
                            </button>
                        </div>
                    </form>
