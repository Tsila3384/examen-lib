...
<div class="admin-container">
    ...
    <div class="content-section">
        <form method="post" action="${pageContext.request.contextPath}/backoffice/pret-direct" class="form-container">

            <div class="form-group">
                <label for="adherentInput" class="form-label">Adhérent</label>
                <input class="form-input" list="adherentsList" id="adherentInput" name="adherentId" required autocomplete="off" placeholder="ID ou nom...">
                <datalist id="adherentsList">
                    <c:forEach var="adherent" items="${adherents}">
                        <option value="${adherent.id}" label="${adherent.nom} ${adherent.prenom} (${adherent.email})"></option>
                    </c:forEach>
                </datalist>
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-input" list="livresList" id="livreInput" name="livreId" required autocomplete="off" placeholder="ID ou titre...">
            ...
            <div class="form-actions">
                ...
                <a href="${pageContext.request.contextPath}/backoffice" class="btn btn-secondary">↩️ Annuler</a>
            </div>
        </form>
